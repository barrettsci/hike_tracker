...
with st.form("log_form", clear_on_submit=True):
    ...
    dur_raw = col5.text_input("Duration (h:mm)", placeholder="e.g. 2:30")
    pack_weight = col6.number_input("Pack weight (kg)", min_value=0.0, max_value=50.0, value=0.0, step=0.5,
